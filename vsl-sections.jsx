  ...
  return (
    <section id="top" className="v-hero" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <Reveal delay={80}>
          <h1 className="v-h1"><b>We'll build a video sales letter funnel for your business and guarantee you at least $30,000 in profit, or you don't&nbsp;pay</b></h1>
        </Reveal>
...
function VslProcess() {
  ...
  const bars = [
    { c: [1, 2], r: 1, t: 'Kickoff Call', s: '60 MIN', you: true, days: 'DAY 1' },
    { c: [1, 3], r: 2, t: 'Design The Offer', s: 'US', days: 'DAY 1–2' },
    { c: [2, 4], r: 3, t: 'Script The VSL', s: 'US', days: 'DAY 2–3' },
    { c: [3, 4], r: 4, t: 'Script The Ads', s: 'US', days: 'DAY 3' },
    { c: [4, 6], r: 1, t: 'Approve & Record', s: '30 MIN + ~2 HRS', you: true, days: 'DAY 4–5' },
    { c: [6, 9], r: 1, t: 'Edit VSL', s: 'US · STARTS WHEN FOOTAGE LANDS', days: 'DAY 6–8' },
    { c: [6, 8], r: 2, t: 'Edit Ads', s: 'US · IN PARALLEL', days: 'DAY 6–7' },
    { c: [8, 9], r: 2, t: 'Set Up Pixel & CAPI', s: 'AD ACCOUNT', days: 'DAY 8' },
    { c: [4, 7], r: 3, t: 'Build The Page', s: 'US · WHILE YOU FILM', days: 'DAY 4–6' },
    { c: [5, 8], r: 4, t: 'Email + SMS', s: 'US', days: 'DAY 5–7' },
